...
/**
* A reader for the FileFragment user type.
*/
public class FileFragmentDataReader extends DataReaderImpl {
    // -----------------------------------------------------------------------
    // Public Methods
    // -----------------------------------------------------------------------

    public void read(FileFragmentSeq received_data, SampleInfoSeq info_seq,
    int max_samples,
    ...
    public void take(FileFragmentSeq received_data, SampleInfoSeq info_seq,
    int max_samples,
    int sample_states, int view_states, int instance_states) {
    ...
    public void read_w_condition(FileFragmentSeq received_data, 
    ...
    public void take_w_condition(FileFragmentSeq received_data, 
    SampleInfoSeq info_seq,
    int max_samples,
    ReadCondition condition) {
    ...
    public void read_instance(FileFragmentSeq received_data, SampleInfoSeq info_seq,
    ...
    public void take_instance(FileFragmentSeq received_data, SampleInfoSeq info_seq,
    int max_samples, InstanceHandle_t a_handle, int sample_states,
    int view_states, int instance_states) {
    ...
    public void read_instance_w_condition(FileFragmentSeq received_data,
    ...
    public void take_instance_w_condition(FileFragmentSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void read_next_instance(FileFragmentSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    ...
    public void take_next_instance(FileFragmentSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, int sample_states, int view_states,
    int instance_states) {
    ...
    public void read_next_instance_w_condition(FileFragmentSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void take_next_instance_w_condition(FileFragmentSeq received_data,
    SampleInfoSeq info_seq, int max_samples,
    InstanceHandle_t a_handle, ReadCondition condition) {
    ...
    public void return_loan(FileFragmentSeq received_data, SampleInfoSeq info_seq) {
    ...
    /*package*/  FileFragmentDataReader (long native_reader, DataReaderListener listener,
