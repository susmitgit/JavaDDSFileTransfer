...
/**
* A sequence of FileFragment instances.
*/
public final class FileFragmentSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    */
    ...
    public FileFragmentSeq() {
        super(FileFragment.class);
    }

    public FileFragmentSeq (int initialMaximum) {
        super(FileFragment.class, initialMaximum);
    }

    public FileFragmentSeq (Collection elements) {
    ...
    */
    public Object copy_from(Object src) {
        ...
        // copy 'new' FileFragment objects (beyond the original size of this object)
